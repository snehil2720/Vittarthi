"""
Django settings for vitarthi project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'vita.context_processors.global_categories',
                'vita.context_processors.site_stats',
            ],
        },
    },
]

WSGI_APPLICATION = 'vitarthi.wsgi.application'
...
AUTH_USER_MODEL = 'vita.CustomUser'
